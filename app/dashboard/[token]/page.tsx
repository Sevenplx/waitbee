    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.headerInner}>
          ...
          <div className={styles.headerAdmin}>Admin: {waitlist.adminEmail}</div>
        </div>
      </header>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.warningBox}>
          ...
          <div>
            <h3 className={styles.warningTitle}>Save this URL!</h3>
            <p className={styles.warningText}>This page is your admin dashboard. Bookmark it now. If you lose this URL, you won&apos;t be able to access your waitlist.</p>
          </div>
        </div>
        ...
        <div className={styles.topSection}>
          ...
          <div className={styles.statsCard}>
            ...
            <a 
              href={`/api/waitlists/${token}/export`}
